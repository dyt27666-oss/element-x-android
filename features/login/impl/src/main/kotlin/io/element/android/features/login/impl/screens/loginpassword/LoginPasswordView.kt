...
fun LoginPasswordView(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Alpha-branded heading: circular brand mark + title + subtitle.
            // Replaces Element's default Icon + URL-bearing title.
            Column(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                Image(
                    ...
                    contentDescription = stringResource(id = R.string.screen_alpha_wordmark),
                ...
                io.element.android.libraries.designsystem.theme.components.Text(
                    text = stringResource(id = R.string.screen_alpha_signin_title),
                ...
                io.element.android.libraries.designsystem.theme.components.Text(
                    text = stringResource(id = R.string.screen_alpha_signin_subtitle),
